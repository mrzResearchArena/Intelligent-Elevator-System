...
def allPossibleCombination(elements):
    # 35% times no call
    # 65% times any calls
    ...
    if p < 0.35:
        ...
        value = list(itertools.product([0, 1], repeat=elements.__len__()))

        randomValue = math.floor(uniform(0.0, value.__len__()))
...
# class Node:
#     def __init__(self, weight, liftPosition):
#         self.weight = weight
#         self.liftPosition = liftPosition
#
#
# def tuplePrac():
#     runningCar = []
#     # abc = Node(45, 6)
#     #
#     # runningCar.append( abc = Node(64, 11) )
#     # runningCar.append( Node(56, 6) )
#     # runningCar.append( Node(79,2) )
#     i=0
#     while i<3:
#         abc = Node(generateWeight(), 96)
#         runningCar.append(abc)
#         i = i+1
        ...
        if elevatorDirection == "up":
            ...
            while i < person:
                ...
                if currentWeight <= 550.0:  # Maximum can carry upto 750.0, when up.
                    ...
                    print("liftPosition = {}".format(liftPosition))
                    ...
                    print("currentWeight = {}".format(currentWeight))
            ...
            print("currentLocation = {}".format(currentLocation))
            ...
            if upStop[currentLocation] == 1:
                ...
                for I in runningCar:
                    ...
                    if I[1] == currentLocation:
                        ...
                        totalServed += 1
                        print("totalServed = {}".format(totalServed))
